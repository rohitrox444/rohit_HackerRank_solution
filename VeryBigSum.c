...
long aVeryBigSum(int ar_count, long* ar) {
    ...
    //here we are getting an array's reference through pointer
    //therefore we don't need to input the elements 
    //we can directly perform sum operation on 'ar' array
